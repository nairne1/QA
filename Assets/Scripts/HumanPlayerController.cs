...
{
    [Header("Scene refs")]
    [Tooltip("Records which cells have been visited")]//for heatmap
    ...
    //called by bug scripts - does nothing for human (they experience bugs naturally)
    public void FoundBug(string bugId)
    {
        //no feedback given to human tester
        //they must observe and document the bug themselves
    }
    ...
    public void Respawn()
    {
        ...
        Debug.Log("[HumanPlayerController] Respawning and triggering OnHumanPlayerRespawn event");
    ...
    {
        Debug.Log("[HumanPlayerController] Resetting player for new session");
    ...
    //called by goal trigger
    public void GoalReached()
    {
        Debug.Log($"Goal reached! Total play time: {_playTime:F2} seconds, Deaths: {_deathCount}, Score: {_score}");
    }
